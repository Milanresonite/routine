...
<div id="container">
      <form action="roomPage.php" method="post">
       ...
       <br><br>
       Room: 
       <input list="room" name="roomno" placeholder="Enter Room No." required id="roomid">
...
//            }
            ...
            $sql1 = 'select time,'.$day.' from '.$roomno.'';
...
//            }
            ...
            echo "<div style='clear:both; width:120%;'> <h3 style=' font-size:1.5em; float:left;'>Room no: $roomno</h3> 
            <h3 style=' font-size:1.5em; float:right;'>Day: $day</h3></div>
            
            ";

            
            echo "<table border='2' style='border-collapse:collapse; width:120%; font-size:1.2em;'>
       <th>Time</th>
       <th>Schedule</th>";
            ...
            for($i=0; $i<sizeof($arrday);$i++){
                ...
                if(($i<sizeof($arrday)-1) && !strcmp($arrday[$i],$arrday[$i+1])){
                    ...
                    echo "<tr> <td style='padding:10px; text-align:center;'>".$arrtime[$i].":00</td>
                          <td rowspan=2 style='padding:10px; width: 60%;text-align:center;'>".$arrday[$i]."</td>
