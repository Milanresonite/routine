...
<div id="container">
      <form action="roomPage1.php" method="post">
         Select Day:
...
//            }
        ...
        $schedule = array();
           ...
           for($i=0; $i<sizeof($roomNo); $i++){
            $sql = 'select '.$day.' from '.$roomNo[$i].' where time = '.$time.'';
       ...
       <th>Schedule</th>";
            ...
            for($i=0; $i<sizeof($schedule); $i++){
                ...
                if(!strcmp('---',$schedule[$i])){
                    ...
                    echo "<tr> <td style='padding:10px; text-align:center;'>".$roomNo[$i]."</td>
                          <td style='padding:10px; text-align:center; width: 60%;background:green;'>Available</td>
                    ...
                    echo "<tr> <td style='padding:10px; text-align:center;'>".$roomNo[$i]."</td>
                          <td style='padding:10px; text-align:center; background:red;'>Locked</td>
