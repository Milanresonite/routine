...
for($i=0; $i<sizeof($facultyDetailsUnique); $i++){
    ...
    array_push($facultyDay,$substring3);
            ...
            echo "<div style='width:auto; height:auto; position:absolute'>";
            echo "<h3 style='width:200px; border:2px solid #0e9d8c; background:#b8d92b; text-align:center; display:inline-block;'>Group</h3>";
            for($i=0; $i<$groupPanel; $i++){
                echo "<div style='border:2px solid #0e9d8c; border-collapse:collapse; width:200px; height:100px; text-align:center; line-height:100px;'>";
            ...
            echo "</div>";
            echo "<div style='margin-left: 200px; width:auto; height:auto; position:absolute'>";
            echo "<h3 style='width:200px; border:2px solid #0e9d8c; background:#b8d92b; text-align:center; display:inline-block;'>Panel</h3>";
           ...
           $facultyCounter = 1;
            echo "<div style='margin-left: 400px; width:auto; height:auto; position:absolute'>";
            echo "<h3 style='width:200px; border:2px solid #0e9d8c; background:#b8d92b; text-align:center; display:inline-block;'>Faculty</h3>";
            for($i=0; $i<$groupPanel; $i++){
                echo "<div style='border:2px solid #0e9d8c; border-collapse:collapse; width:200px; height:100px; text-align:center;' id='facultyName$i'>";
                // for($j=0; $j<$panel; $j++){
                    echo " ";
                //     $facultyCounter++;
                // }
            ...
            echo "</div>";
            echo "<div style='margin-left: 600px; width:auto; height:auto; position:absolute'>";
            echo "<h3 style='width:200px; border:2px solid #0e9d8c; background:#b8d92b; text-align:center; display:inline-block;'>Date</h3>";
            for($i=1; $i<=$groupPanel; $i++){
                echo "<div style='border:2px solid #0e9d8c; border-collapse:collapse; width:200px; height:100px; text-align:center; line-height:100px;'>";
            ...
            echo "</div>";
             ...
             echo "</div>";
            echo "<div style='margin-left: 800px; width:auto; height:auto; position:absolute'>";
            echo "<h3 style='width:200px; border:2px solid #0e9d8c; background:#b8d92b; text-align:center; display:inline-block;'>Room</h3>";
            for($i=1; $i<=$groupPanel; $i++){
                echo "<div style='border:2px solid #0e9d8c; width:200px; height:100px; text-align:center; line-height:100px;' id ='facultyRooms$i'>";
            ...
            echo "</div>";
            echo "<div style='margin-left: 1000px; width:auto; height:auto; position:absolute'>";
            echo "<h3 style='width:200px; border:2px solid #0e9d8c; background:#b8d92b; text-align:center; display:inline-block;'>TIme</h3>";
            for($j=1; $j<=$groupPanel; $j++){
                echo "<div style='border:2px solid #0e9d8c; width:200px; border-collapse:collapse; height:100px; text-align:center; line-height:100px;' id='facultyTimes$j'>";
...
<!-- <div><button style="position: absolute; clear: both;">Print</button></div> -->
